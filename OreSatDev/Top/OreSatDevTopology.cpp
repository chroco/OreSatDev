// ======================================================================
// \title  OreSatDevTopology.cpp
// \brief cpp file containing the topology instantiation code
//
// ======================================================================
// Provides access to autocoded functions
#include <OreSatDev/Top/OreSatDevTopologyAc.hpp>

#include <Fw/Logger/Logger.hpp>

// Note: Uncomment when using Svc:TlmPacketizer
//#include <OreSatDev/Top/OreSatDevPacketsAc.hpp>
...
Svc::Health::PingEntry pingEntries[] = {
    {PingEntries::OreSatDev_blockDrv::WARN, PingEntries::OreSatDev_blockDrv::FATAL, "blockDrv"},
    {PingEntries::OreSatDev_tlmSend::WARN, PingEntries::OreSatDev_tlmSend::FATAL, "chanTlm"},
    {PingEntries::OreSatDev_cmdDisp::WARN, PingEntries::OreSatDev_cmdDisp::FATAL, "cmdDisp"},
    {PingEntries::OreSatDev_cmdSeq::WARN, PingEntries::OreSatDev_cmdSeq::FATAL, "cmdSeq"},
    {PingEntries::OreSatDev_eventLogger::WARN, PingEntries::OreSatDev_eventLogger::FATAL, "eventLogger"},
    {PingEntries::OreSatDev_fileDownlink::WARN, PingEntries::OreSatDev_fileDownlink::FATAL, "fileDownlink"},
    {PingEntries::OreSatDev_fileManager::WARN, PingEntries::OreSatDev_fileManager::FATAL, "fileManager"},
    {PingEntries::OreSatDev_fileUplink::WARN, PingEntries::OreSatDev_fileUplink::FATAL, "fileUplink"},
    {PingEntries::OreSatDev_prmDb::WARN, PingEntries::OreSatDev_prmDb::FATAL, "prmDb"},
    {PingEntries::OreSatDev_rateGroup1::WARN, PingEntries::OreSatDev_rateGroup1::FATAL, "rateGroup1"},
    {PingEntries::OreSatDev_rateGroup2::WARN, PingEntries::OreSatDev_rateGroup2::FATAL, "rateGroup2"},
    {PingEntries::OreSatDev_rateGroup3::WARN, PingEntries::OreSatDev_rateGroup3::FATAL, "rateGroup3"},
};
...
void configureTopology() {
    ...
    // Note: Uncomment when using Svc:TlmPacketizer
    // tlmSend.setPacketList(OreSatDevPacketsPkts, OreSatDevPacketsIgnore, 1);
