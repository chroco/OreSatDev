// ======================================================================
// \title  OreSatDevTopology.hpp
// \brief header file containing the topology instantiation definitions
//
// ======================================================================
#ifndef ORESATDEV_ORESATDEVTOPOLOGY_HPP
#define ORESATDEV_ORESATDEVTOPOLOGY_HPP
// Included for access to OreSatDev::TopologyState and OreSatDev::ConfigObjects::pingEntries. These definitions are required by the
// autocoder, but are also used in this hand-coded topology.
#include <OreSatDev/Top/OreSatDevTopologyDefs.hpp>

// Remove unnecessary OreSatDev:: qualifications
 ...
 * OreSatDev::TopologyState see: OreSatDevTopologyDefs.hpp.
 *
 ...
 *
 * For an explanation of the required type OreSatDev::TopologyState see: OreSatDevTopologyDefs.hpp.
 *
 ...
 */
//void startSimulatedCycle(Fw::TimeInterval interval = Fw::TimeInterval(0,1));
